...
function ActivityRenderer({ activity, courseUuid, orgUuid, orgSlug }: { activity: PlayerActivity; courseUuid: string; orgUuid: string; orgSlug: string }) {
  ...
  if (activity.activity_type === 'TYPE_ASSIGNMENT') return <XpexAssignment activityUuid={activity.activity_uuid} courseUuid={courseUuid} orgUuid={orgUuid} orgSlug={orgSlug} />
