        ...
        >
                ...
                <div className="flex-1 flex items-center justify-center px-6 md:px-12 lg:px-20">
                    <div className="w-full max-w-[420px] py-10">
                        ...
                        <p className="mt-2 text-white/55 text-[15px] font-medium">{t('auth.reset_password_description')}</p>
                        ...
                        <div className="mt-8">
                            <FormLayout onSubmit={formik.handleSubmit}>
                                ...
                                <FormField name="reset_code">
                                    <div className="flex items-center space-x-2 mb-1.5">
                                        <Form.Label className="grow text-[13px] font-semibold text-white/75">{t('auth.reset_code')}</Form.Label>
                                ...
                                <FormField name="new_password">
                                    <div className="flex items-center space-x-2 mb-1.5">
                                        <Form.Label className="grow text-[13px] font-semibold text-white/75">{t('auth.new_password')}</Form.Label>
                                ...
                                <FormField name="confirm_password">
                                    <div className="flex items-center space-x-2 mb-1.5">
                                        <Form.Label className="grow text-[13px] font-semibold text-white/75">{t('auth.confirm_password')}</Form.Label>
