...
import { xpexAdminRoute, xpexCourseStudioRoute, xpexPoloCoursesRoute } from '@/lib/xpexRouteMap'
...
function EntryPoints({ role, organizationSlug }: { role: XpexRole; organizationSlug?: string }) {
  const courseLink = organizationSlug ? xpexPoloCoursesRoute(organizationSlug) : null
