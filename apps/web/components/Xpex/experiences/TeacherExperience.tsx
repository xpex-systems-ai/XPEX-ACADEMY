...
import { XpexActionCard, XpexBadge, XpexDemoButton, XpexHero, XpexMetricCard, XpexPanel, XpexProgressBar, XpexSectionHeader, XpexStatusBadge } from '../XpexPrimitives'
...
export function TeacherExperience() {
  return <div className="space-y-5">
    ...
    <div id="turma" className="grid gap-5 xl:grid-cols-[1.45fr_.55fr]">
      ...
      <XpexPanel id="atividades" className="relative overflow-hidden border-orange-500/25 bg-orange-500/[.05]"><Lightbulb aria-hidden="true" className="text-orange-400" /><p className="xpex-label mt-5 !text-orange-400">Próxima ação sugerida</p><h2 className="mt-2 text-xl font-black text-white">Revisar dois mapas enviados</h2><p className="mt-3 text-sm leading-6 text-slate-400">Prepare uma pergunta acolhedora para cada projeto e planeje a próxima mentoria.</p><XpexDemoButton>Abrir fila demonstrativa</XpexDemoButton></XpexPanel>
    </div>
    ...
    <div className="grid gap-5 lg:grid-cols-2">
      <XpexPanel id="eventos"><CalendarDays aria-hidden="true" className="text-cyan-300" /><p className="xpex-label mt-5">Mentorias e agenda</p><h2 className="mt-2 text-xl font-black text-white">Próximo encontro da turma</h2><p className="mt-3 text-sm leading-6 text-slate-400">Mentoria demonstrativa • agenda configurável • pauta fictícia: perguntas orientadoras para os projetos.</p></XpexPanel>
