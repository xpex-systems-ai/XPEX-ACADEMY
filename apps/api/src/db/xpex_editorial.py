...
class XPeXEditorialDraft(SQLModel, table=True):
    ...
    review_json: dict | None = Field(default=None, sa_column=Column(JSON, nullable=True))
    generated_by: str = Field(default="", max_length=200)
    reviewed_by: str | None = Field(default=None, max_length=200)
    reviewed_revision: int | None = None
    reviewed_content_hash: str | None = Field(default=None, max_length=64)
    ...
    approved_content_hash: str | None = Field(default=None, max_length=64)
    approved_at: str | None = Field(default=None, max_length=64)

    native_course_id: int | None = Field(
        default=None,
    ...
    native_mapping: dict | None = Field(default=None, sa_column=Column(JSON, nullable=True))
    published_at: str | None = Field(default=None, max_length=64)
    publication_error: str | None = Field(default=None, max_length=500)
